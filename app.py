...
@st.cache_resource
def generate_mega_institutional_matrix_v98_modified():
...
df = generate_mega_institutional_matrix_v98_modified()
...
if len(st.session_state.result_history) >= 2 and len(st.session_state.period_history) >= 2:
    ...
    # 🧠 [মডিফাইড প্রশ্ন ৩ সমাধান - পিওর ডাইনামিক জোন সেপারেশন লুপ]
    # বিগ এবং স্মলের ৫টি সুনির্দিষ্ট সংখ্যাকে আলাদা অ্যারে গ্রিডে লক করা হলো
    pure_big_nums = [5, 6, 7, 8, 9]
    pure_small_nums = [0, 1, 2, 3, 4]
    
    # শেষ ১৫ রাউন্ডের কারেন্ট ফ্রিকোয়েন্সি তীব্রতা বা ঘনত্ব মেমরিতে নেওয়া হচ্ছে
    dynamic_bigs = sorted(pure_big_nums, key=lambda x: res_hist.count(x))[:3]
    dynamic_smalls = sorted(pure_small_nums, key=lambda x: res_hist.count(x))[:3]
    
    dynamic_big_text = ", ".join(map(str, sorted(dynamic_bigs)))
    dynamic_small_text = ", ".join(map(str, sorted(dynamic_smalls)))
    
    # 🧬 [প্রশ্ন ২ সমাধান - গ্লোবাল মার্কেট ক্যাটাগরি ও মুভমেন্ট রাডার প্যানেল ডিসপ্লে]
    is_dragon_active = False
    is_special_movement = False
    
    # প্রতিটি রেজাল্ট দেওয়ার আগেই অল সার্ভার অ্যানালাইসিস করে ক্যাটাগরি নির্দিষ্ট করছে
    ...
    # 🚨 [স্বয়ংক্রিয় ১০০% নিখুঁত ভুল সিদ্ধান্ত ট্র্যাকিং লুপ]: কাটায় কাটায় ৪ লস পূর্ণ হলেই কেবল লাল প্রোটেকশন অন হবে
    ...
    # 🎯 [প্রশ্ন ৩ সমাধান - জোন ভিত্তিক সংখ্যা বরাদ্দকরণ মেকানিজম]
    # সিগন্যাল বিগ আসলে শুধুমাত্র বিগের সংখ্যা এবং স্মল আসলে শুধুমাত্র স্মলের সংখ্যা ভাসবে
    ...
    # ⚡ [প্রশ্ন ১ সমাধান - ওয়ান (১) থেকে টু (২) স্টেপ লস যাওয়ার পর অল সার্ভার কোয়ান্টাম বুস্ট অ্যাক্টিভ]
