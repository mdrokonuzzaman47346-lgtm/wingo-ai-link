...
if len(st.session_state.result_history) >= 2 and len(st.session_state.period_history) >= 2:
    ...
    # 🚨 [স্বয়ংক্রিয় ভুল সিদ্ধান্ত ট্র্যাকিং লুপ]: কাটায় কাটায় ৪ লস পূর্ণ হলেই কেবল লাল প্রোটেকশন অন হবে
    ...
    # 🛑 [লোহার শৃঙ্খলা সুরক্ষাকবচ] চার্টের ড্রাগনকে স্পর্শ না করে—শুধুমাত্র ড্যাশবোর্ডের ৪টি সিদ্ধান্ত ভুল হলেই লাল চিহ্ন আসবে
